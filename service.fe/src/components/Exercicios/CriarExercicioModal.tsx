...
export const CriarExercicioModal = ({
  ...
  // Fazer reset ao formulário sempre que o modal abre
  useEffect(() => {
    if (isOpen) {
      setPasso(1);
      setUploading(false);
  ...
  async function handleCriar() {
    ...
    try {
      ...
      await exerciciosService.create(payload);
      onSucesso(); // Chama a função no componente pai apenas para atualizar a lista
      setPasso(3); // Avança para o ecrã de sucesso dentro do modal
    } catch (err) {
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, nome_exercicio: e.target.value })
                    }
                  />
                </div>
